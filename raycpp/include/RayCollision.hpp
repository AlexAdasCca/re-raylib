...
public:
     ...
     */
    RayCollision(const ::Ray& ray, const ::BoundingBox& box) { set(::RLGetRayCollisionBox(ray, box)); }

    /**
     * Get collision info between ray and mesh
     */
    RayCollision(const ::Ray& ray, const ::Mesh& mesh, const ::Matrix& transform) {
        set(::RLGetRayCollisionMesh(ray, mesh, transform));
    }
    ...
    RayCollision(const ::Ray& ray, ::Vector3 p1, ::Vector3 p2, ::Vector3 p3, ::Vector3 p4) {
        set(::RLGetRayCollisionQuad(ray, p1, p2, p3, p4));
    }
    ...
    RayCollision(const ::Ray& ray, ::Vector3 center, float radius) {
        set(::RLGetRayCollisionSphere(ray, center, radius));
    }
    ...
    RayCollision(const ::Ray& ray, ::Vector3 p1, ::Vector3 p2, ::Vector3 p3) {
        set(::RLGetRayCollisionTriangle(ray, p1, p2, p3));
    }
