...
public:
     ...
     */
    AutomationEventList() { set(::RLLoadAutomationEventList(0)); }
    ...
    void Load(const char* fileName) {
        Unload();
        set(::RLLoadAutomationEventList(fileName));
        if (!IsValid()) {
...
// The function signature of UnloadAutomationEventList() changes from raylib 5.0.
        ...
        ::RLUnloadAutomationEventList(this);
    ...
    bool Export(const char* fileName) { return ::RLExportAutomationEventList(*this, fileName); }

    void Set() { ::RLSetAutomationEventList(this); }

    void SetBaseFrame(int frame) {
        Set();
        ::RLSetAutomationEventBaseFrame(frame);
    }
    ...
    void Play(int index) {
        ...
        Set();
        ::RLPlayAutomationEvent(this->events[index]);
    }
protected:
