...
public:
     ...
     */
    Matrix GetMatrix() const { return ::RLGetCameraMatrix2D(*this); }

    /**
     * Returns the world space position for a 2d camera screen space position
     */
    Vector2 GetScreenToWorld(::Vector2 position) const { return ::RLGetScreenToWorld2D(position, *this); }

    /**
     * Returns the screen space position for a 2d world space position
     */
    Vector2 GetWorldToScreen(::Vector2 position) const { return ::RLGetWorldToScreen2D(position, *this); }
protected:
