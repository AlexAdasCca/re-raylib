...
public:
    ...
    Sound& Update(const void* data, int samplesCount) {
        ::RLUpdateSound(*this, data, samplesCount);
        return *this;
    }
    ...
    Sound& Update(const void* data) {
        ::RLUpdateSound(*this, data, static_cast<int>(frameCount));
        return *this;
    }
     ...
     */
    bool IsPlaying() const { return ::RLIsSoundPlaying(*this); }

    /**
     * Set volume for a sound (1.0 is max level)
     */
    Sound& SetVolume(float volume) {
        ::RLSetSoundVolume(*this, volume);
        return *this;
    }
    ...
    void Load(const std::string& fileName) {
        set(::RLLoadSound(fileName.c_str()));
        if (!IsValid()) {
     ...
     */
    bool IsValid() const { return ::RLIsSoundValid(*this); }
protected:
