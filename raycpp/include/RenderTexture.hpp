...
public:
     ...
     */
    RenderTexture(int width, int height) { set(::RLLoadRenderTexture(width, height)); }
    ...
    void Unload() { RLUnloadRenderTexture(*this); }

    /**
     * Initializes render texture for drawing
     */
    RenderTexture& BeginMode() {
        ::RLBeginTextureMode(*this);
        return *this;
    }
     ...
     * Load texture for rendering (framebuffer)
     */
    static RenderTexture Load(int width, int height) { return ::RLLoadRenderTexture(width, height); }

    /**
     * Retrieves whether or not the render texture is ready.
     */
    bool IsValid() const { return ::RLIsRenderTextureValid(*this); }
protected:
