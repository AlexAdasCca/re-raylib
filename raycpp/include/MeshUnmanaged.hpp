...
public:
     ...
     */
    static ::Mesh Poly(int sides, float radius) { return ::RLGenMeshPoly(sides, radius); }

    /**
     * Generate plane mesh (with subdivisions)
     */
    static ::Mesh Plane(float width, float length, int resX, int resZ) {
        return ::RLGenMeshPlane(width, length, resX, resZ);
    }

    /**
     * Generate cuboid mesh
     */
    static ::Mesh Cube(float width, float height, float length) { return ::RLGenMeshCube(width, height, length); }

    /**
     * Generate sphere mesh (standard sphere)
     */
    static ::Mesh Sphere(float radius, int rings, int slices) { return ::RLGenMeshSphere(radius, rings, slices); }

    /**
     * Generate half-sphere mesh (no bottom cap)
     */
    static ::Mesh HemiSphere(float radius, int rings, int slices) {
        return ::RLGenMeshHemiSphere(radius, rings, slices);
    }
    ...
    static ::Mesh Cylinder(float radius, float height, int slices) {
        return ::RLGenMeshCylinder(radius, height, slices);
    }

    /**
     * Generate cone/pyramid mesh
     */
    static ::Mesh Cone(float radius, float height, int slices) { return ::RLGenMeshCone(radius, height, slices); }

    /**
     * Generate torus mesh
     */
    static ::Mesh Torus(float radius, float size, int radSeg, int sides) {
        return ::RLGenMeshTorus(radius, size, radSeg, sides);
    }
    ...
    static ::Mesh Knot(float radius, float size, int radSeg, int sides) {
        return ::RLGenMeshKnot(radius, size, radSeg, sides);
    }

    /**
     * Generate heightmap mesh from image data
     */
    static ::Mesh Heightmap(const ::Image& heightmap, ::Vector3 size) { return ::RLGenMeshHeightmap(heightmap, size); }

    /**
     * Generate cubes-based map mesh from image data
     */
    static ::Mesh Cubicmap(const ::Image& cubicmap, ::Vector3 cubeSize) {
        return ::RLGenMeshCubicmap(cubicmap, cubeSize);
    }
     ...
     */
    void Upload(bool dynamic = false) { ::RLUploadMesh(this, dynamic); }

    /**
     * Upload mesh vertex data to GPU (VRAM)
     */
    void UpdateBuffer(int index, void* data, int dataSize, int offset = 0) {
        ::RLUpdateMeshBuffer(*this, index, data, dataSize, offset);
    }

    /**
     * Draw a 3d mesh with material and transform
     */
    void Draw(const ::Material& material, const ::Matrix& transform) const { ::RLDrawMesh(*this, material, transform); }

    /**
     * Draw multiple mesh instances with material and different transforms
     */
    void Draw(const ::Material& material, ::Matrix* transforms, int instances) const {
        ::RLDrawMeshInstanced(*this, material, transforms, instances);
    }
    ...
    void Export(const std::string& fileName) {
        if (!::RLExportMesh(*this, fileName.c_str())) {
    ...
    void ExportCode(const std::string& fileName) {
        if (!::RLExportMeshAsCode(*this, fileName.c_str())) {
            throw RaylibException("Failed to export the Mesh");
        }
    }
     ...
     */
    raylib::BoundingBox BoundingBox() const { return ::RLGetMeshBoundingBox(*this); }
     ...
     */
    raylib::Model LoadModelFrom() const { return ::RLLoadModelFromMesh(*this); }

    /**
     * Load model from generated mesh
     */
    operator raylib::Model() { return ::RLLoadModelFromMesh(*this); }

    /**
     * Returns whether or not the Mesh is valid.
     */
    bool IsValid() { return ::RLIsModelValid(*this); }
