...
public:
     ...
     */
    ::Wave Copy() const { return ::RLWaveCopy(*this); }

    /**
     * Crop a wave to defined samples range
     */
    Wave& Crop(int initSample, int finalSample) {
        ::RLWaveCrop(this, initSample, finalSample);
        return *this;
    }
    ...
    Wave& Format(int SampleRate, int SampleSize, int Channels = 2) {
        ::RLWaveFormat(this, SampleRate, SampleSize, Channels);
        return *this;
    }
     ...
     */
    float* LoadSamples() { return ::RLLoadWaveSamples(*this); }

    /**
     * Unload samples data loaded with LoadWaveSamples()
     */
    static void UnloadSamples(float* samples) { ::RLUnloadWaveSamples(samples); }
    ...
    bool Export(const std::string& fileName) {
        ...
        return ::RLExportWave(*this, fileName.c_str());
    }
    ...
    bool ExportAsCode(const std::string& fileName) {
        // TODO(RobLoach): Throw exception on error.
        return ::RLExportWaveAsCode(*this, fileName.c_str());
    }
     ...
     */
    ::Sound LoadSound() { return ::RLLoadSoundFromWave(*this); }
    ...
    void Load(const std::string& fileType, const unsigned char* fileData, int dataSize) {
        set(::RLLoadWaveFromMemory(fileType.c_str(), fileData, dataSize));
        if (!IsValid()) {
     ...
     */
    bool IsValid() const { return ::RLIsWaveValid(*this); }
protected:
