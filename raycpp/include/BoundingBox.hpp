...
public:
     ...
     */
    BoundingBox(const ::Mesh& mesh) { set(::RLGetMeshBoundingBox(mesh)); }
     ...
     */
    void Draw(::Color color = {255, 255, 255, 255}) const { ::RLDrawBoundingBox(*this, color); }

    /**
     * Detect collision between two boxes
     */
    bool CheckCollision(const ::BoundingBox& box2) const { return RLCheckCollisionBoxes(*this, box2); }

    /**
     * Detect collision between box and sphere
     */
    bool CheckCollision(::Vector3 center, float radius) const {
        return RLCheckCollisionBoxSphere(*this, center, radius);
    }

    /**
     * Detect collision between ray and bounding box
     */
    bool CheckCollision(const ::Ray& ray) const { return RLGetRayCollisionBox(ray, *this).hit; }

    /**
     * Get collision information between ray and bounding box
     */
    RayCollision GetCollision(const ::Ray& ray) const { return RLGetRayCollisionBox(ray, *this); }
protected:
