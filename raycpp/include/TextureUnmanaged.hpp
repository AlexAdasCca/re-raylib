...
public:
    ...
    void Load(const ::Image& image) {
        set(::RLLoadTextureFromImage(image));
        if (!IsValid()) {
    ...
    void Load(const ::Image& image, int layoutType) {
        set(::RLLoadTextureCubemap(image, layoutType));
        if (!IsValid()) {
    ...
    void Load(const std::string& fileName) {
        set(::RLLoadTexture(fileName.c_str()));
        if (!IsValid()) {
    ...
    TextureUnmanaged& Update(::Rectangle rec, const void* pixels) {
        RLUpdateTextureRec(*this, rec, pixels);
        return *this;
    }
     ...
     */
    ::Image GetData() const { return ::RLLoadImageFromTexture(*this); }
    ...
    TextureUnmanaged& SetFilter(int filterMode) {
        ::RLSetTextureFilter(*this, filterMode);
        return *this;
    }
    ...
    TextureUnmanaged& SetWrap(int wrapMode) {
        ::RLSetTextureWrap(*this, wrapMode);
        return *this;
    }
    ...
    void Draw(int posX = 0, int posY = 0, ::Color tint = {255, 255, 255, 255}) const {
        ::RLDrawTexture(*this, posX, posY, tint);
    }
    ...
    void Draw(::Vector2 position, ::Color tint = {255, 255, 255, 255}) const {
        ::RLDrawTextureV(*this, position, tint);
    }
    ...
    void Draw(::Vector2 position, float rotation, float scale = 1.0f, ::Color tint = {255, 255, 255, 255}) const {
        ::RLDrawTextureEx(*this, position, rotation, scale, tint);
    }
    ...
    void Draw(::Rectangle sourceRec, ::Vector2 position = {0, 0}, ::Color tint = {255, 255, 255, 255}) const {
        ::RLDrawTextureRec(*this, sourceRec, position, tint);
    }
    ...
    void Draw(
        ...
        ::RLDrawTexturePro(*this, sourceRec, destRec, origin, rotation, tint);
    }
    ...
    void Draw(
        ...
        float rotation = 0,
        ::Color tint = {255, 255, 255, 255}) const {
        ::RLDrawTextureNPatch(*this, nPatchInfo, destRec, origin, rotation, tint);
    }
    ...
    DrawBillboard(const ::Camera& camera, ::Vector3 position, float size, ::Color tint = {255, 255, 255, 255}) const {
        ::RLDrawBillboard(camera, *this, position, size, tint);
    }
    ...
    void DrawBillboard(
        ...
        ::Vector2 size,
        ::Color tint = {255, 255, 255, 255}) const {
        RLDrawBillboardRec(camera, *this, source, position, size, tint);
    }
    ...
    void DrawBillboard(
        ...
        float rotation = 0.0f,
        ::Color tint = {255, 255, 255, 255}) const {
        RLDrawBillboardPro(camera, *this, source, position, up, size, origin, rotation, tint);
    }
    ...
    TextureUnmanaged& SetMaterial(::Material* material, int mapType = MATERIAL_MAP_NORMAL) {
        ::RLSetMaterialTexture(material, mapType, *this);
        return *this;
    }

    TextureUnmanaged& SetMaterial(const ::Material& material, int mapType = MATERIAL_MAP_NORMAL) {
        ::RLSetMaterialTexture((::Material*)(&material), mapType, *this);
        return *this;
    }
    ...
    TextureUnmanaged& SetShapes(const ::Rectangle& source) {
        ::RLSetShapesTexture(*this, source);
        return *this;
    }
    ...
    TextureUnmanaged& SetShaderValue(const ::Shader& shader, int locIndex) {
        ::RLSetShaderValueTexture(shader, locIndex, *this);
        return *this;
    }
     ...
     */
    bool IsValid() const { return RLIsTextureValid(*this); }
protected:
