...
public:
    ...
    ShaderUnmanaged(const std::string& vsFileName, const std::string& fsFileName) {
        set(::RLLoadShader(vsFileName.c_str(), fsFileName.c_str()));
    }
    ShaderUnmanaged(const char* vsFileName, const char* fsFileName) { set(::RLLoadShader(vsFileName, fsFileName)); }
    ...
    static ::Shader Load(const std::string& vsFileName, const std::string& fsFileName) {
        return ::RLLoadShader(vsFileName.c_str(), fsFileName.c_str());
    }
    static ::Shader Load(const char* vsFileName, const char* fsFileName) {
        return ::RLLoadShader(vsFileName, fsFileName);
    }
    ...
    static ::Shader LoadFromMemory(const std::string& vsCode, const std::string& fsCode) {
        return ::RLLoadShaderFromMemory(vsCode.c_str(), fsCode.c_str());
    }
    static ::Shader LoadFromMemory(const char* vsCode, const char* fsCode) {
        return ::RLLoadShaderFromMemory(vsCode, fsCode);
    }
     ...
     */
    int GetLocation(const std::string& uniformName) const { return ::RLGetShaderLocation(*this, uniformName.c_str()); }
    ...
    int GetLocationAttrib(const std::string& attribName) const {
        return ::RLGetShaderLocationAttrib(*this, attribName.c_str());
    }
    ...
    ShaderUnmanaged& SetValue(int uniformLoc, const void* value, int uniformType) {
        ::RLSetShaderValue(*this, uniformLoc, value, uniformType);
        return *this;
    }
    ...
    ShaderUnmanaged& SetValue(int uniformLoc, const void* value, int uniformType, int count) {
        ::RLSetShaderValueV(*this, uniformLoc, value, uniformType, count);
        return *this;
    }
    ...
    ShaderUnmanaged& SetValue(int uniformLoc, const ::Matrix& mat) {
        ::RLSetShaderValueMatrix(*this, uniformLoc, mat);
        return *this;
    }
    ...
    ShaderUnmanaged& SetValue(int uniformLoc, const ::Texture2D& texture) {
        ::RLSetShaderValueTexture(*this, uniformLoc, texture);
        return *this;
    }
     ...
     */
    bool IsValid() const { return ::RLIsShaderValid(*this); }
protected:
