...
public:
     ...
     */
    void Draw(::Color color) const { ::RLDrawRectangleRec(*this, color); }

    void Draw(::Vector2 origin, float rotation, ::Color color) const {
        ::RLDrawRectanglePro(*this, origin, rotation, color);
    }

    void DrawGradientV(::Color color1, ::Color color2) const {
        ::RLDrawRectangleGradientV(
            static_cast<int>(x),
            static_cast<int>(y),
    ...
    void DrawGradient(::Color topLeft, ::Color bottomLeft, ::Color topRight, ::Color bottomRight) const {
        ::RLDrawRectangleGradientEx(*this, topLeft, bottomLeft, topRight, bottomRight);
    }

    void DrawLines(::Color color) const {
        ::RLDrawRectangleLines(
            static_cast<int>(x),
            static_cast<int>(y),
            static_cast<int>(width),
            static_cast<int>(height),
    ...
    void DrawLines(::Color color, float lineThick) const { ::RLDrawRectangleLinesEx(*this, lineThick, color); }

    void DrawRounded(float roundness, int segments, ::Color color) const {
        ::RLDrawRectangleRounded(*this, roundness, segments, color);
    }

    void DrawRoundedLines(float roundness, int segments, ::Color color) const {
        ::RLDrawRectangleRoundedLines(*this, roundness, segments, color);
    }

    void DrawRoundedLines(float roundness, int segments, float lineThick, ::Color color) const {
        RLDrawRectangleRoundedLinesEx(*this, roundness, segments, lineThick, color);
    }

    /**
     * Check collision between two rectangles
     */
    bool CheckCollision(::Rectangle rec2) const { return ::RLCheckCollisionRecs(*this, rec2); }

    /**
     * Get collision rectangle for two rectangles collision
     */
    ::Rectangle GetCollision(::Rectangle rec2) const { return ::RLGetCollisionRec(*this, rec2); }

    /**
     * Check if point is inside rectangle
     */
    bool CheckCollision(::Vector2 point) const { return ::RLCheckCollisionPointRec(point, *this); }

    /**
     * Check collision between circle and rectangle
     */
    bool CheckCollision(::Vector2 center, float radius) const {
        return ::RLCheckCollisionCircleRec(center, radius, *this);
    }
    ...
    Rectangle& SetShapesTexture(const ::Texture2D& texture) {
        ::RLSetShapesTexture(texture, *this);
        return *this;
    }
