...
public:
     ...
     */
    Matrix GetMatrix() const { return ::RLGetCameraMatrix(*this); }

    /**
     * Update camera position for selected mode
     */
    Camera3D& Update(int mode) {
        ::RLUpdateCamera(this, mode);
        return *this;
    }
    ...
    Camera3D& Update(::Vector3 movement, ::Vector3 rotation, float zoom = 1.0f) {
        ::RLUpdateCameraPro(this, movement, rotation, zoom);
        return *this;
    }
     ...
     */
    Vector2 GetWorldToScreen(::Vector3 position) const { return ::RLGetWorldToScreen(position, *this); }

    /**
     * Get a ray trace from screen position (i.e mouse) in a viewport
     */
    Ray GetScreenToWorldRay(::Vector2 position, int width, int height) {
        return ::RLGetScreenToWorldRayEx(position, *this, width, height);
    }
    ...
    DrawBillboard(const ::Texture2D& texture, ::Vector3 center, float size, ::Color tint = {255, 255, 255, 255}) const {
        ::RLDrawBillboard(*this, texture, center, size, tint);
    }
    ...
    void DrawBillboard(
        ...
        ::RLDrawBillboardRec(*this, texture, sourceRec, center, size, tint);
    }
protected:
