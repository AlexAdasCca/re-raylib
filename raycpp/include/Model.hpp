...
public:
    ...
    Model& SetMeshMaterial(int meshId, int materialId) {
        ::RLSetModelMeshMaterial(this, meshId, materialId);
        return *this;
    }
    ...
    Model& UpdateAnimation(const ::ModelAnimation& anim, int frame) {
        ::RLUpdateModelAnimation(*this, anim, frame);
        return *this;
    }
    ...
    Model& UpdateAnimationBones(const ::ModelAnimation& anim, int frame) {
        ::RLUpdateModelAnimationBones(*this, anim, frame);
        return *this;
    }
     ...
     */
    bool IsModelAnimationValid(const ::ModelAnimation& anim) const { return ::RLIsModelAnimationValid(*this, anim); }

    /**
     * Draw a model (with texture if set)
     */
    void Draw(::Vector3 position, float scale = 1.0f, ::Color tint = {255, 255, 255, 255}) const {
        ::RLDrawModel(*this, position, scale, tint);
    }
    ...
    void Draw(
        ...
        ::RLDrawModelEx(*this, position, rotationAxis, rotationAngle, scale, tint);
    }
    ...
    void DrawWires(::Vector3 position, float scale = 1.0f, ::Color tint = {255, 255, 255, 255}) const {
        ::RLDrawModelWires(*this, position, scale, tint);
    }
    ...
    void DrawWires(
        ...
        ::Vector3 scale = {1.0f, 1.0f, 1.0f},
        ::Color tint = {255, 255, 255, 255}) const {
        ::RLDrawModelWiresEx(*this, position, rotationAxis, rotationAngle, scale, tint);
    }
    ...
    void DrawPoints(::Vector3 position, float scale = 1.0f, ::Color tint = {255, 255, 255, 255}) {
        ::RLDrawModelPoints(*this, position, scale, tint);
    }
    ...
    void DrawPoints(::Vector3 position, ::Vector3 rotationAxis, float rotationAngle = 0.0f, ::Vector3 scale = {1.0f, 1.0f, 1.0f}, ::Color tint = {255, 255, 255, 255}) {
        ::RLDrawModelPointsEx(*this, position, rotationAxis, rotationAngle, scale, tint);
    }

    /**
     * Compute model bounding box limits (considers all meshes)
     */
    BoundingBox GetBoundingBox() const { return ::RLGetModelBoundingBox(*this); }

    /**
     * Compute model bounding box limits (considers all meshes)
     */
    operator BoundingBox() const { return ::RLGetModelBoundingBox(*this); }

    /**
     * Determines whether or not the Model has data in it.
     */
    bool IsValid() const { return ::RLIsModelValid(*this); }
    ...
    void Load(const std::string& fileName) {
        set(::RLLoadModel(fileName.c_str()));
        if (!IsValid()) {
