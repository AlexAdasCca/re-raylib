...
//----------------------------------------------------------------------------------
void RLSetTraceLogCallback(TraceLogCallback callback) { traceLog = callback; }              // Set custom trace log
void RLSetLoadFileDataCallback(LoadFileDataCallback callback) { loadFileData = callback; }  // Set custom file data loader
void RLSetSaveFileDataCallback(SaveFileDataCallback callback) { saveFileData = callback; }  // Set custom file data saver
void RLSetLoadFileTextCallback(LoadFileTextCallback callback) { loadFileText = callback; }  // Set custom file text loader
void RLSetSaveFileTextCallback(SaveFileTextCallback callback) { saveFileText = callback; }  // Set custom file text saver
...
bool RLSaveFileText(const char *fileName, char *text)
{
    bool success = false;
...
void RLInitAssetManager(AAssetManager *manager, const char *dataPath)
{
